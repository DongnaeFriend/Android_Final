                ...
                api.getMoneyHistory(Year, Month, Day, "Bearer $authToken")
                    .enqueue(object : Callback<MoneyHistoryResponse> {
                        ...
                        override fun onResponse(
                            ...
                            var data0 = data[0].toString()
                            var data1 = data[1].toString()
                            var data2 = data[2].toString()
                            var data3 = data[3].toString()
                            var data4 = data[4].toString()
                            var data5 = data[5].toString()
                            var data6 = data[6].toString()
                            var data7 = data[7].toString()
                            var data8 = data[8].toString()
                            var data9 = data[9].toString()
                            ...
                            if(category0 == " transactionCategory=식비"){
                                ...
                                binding.tvListcategory1.text = "나는 바보야"
                            ...
                            var Data5 = data5.split(",")

                            var type5 = data5[1]
                            var category5 = data5[2]
                            var price5 = data5[6]
                            var memo5 = data5[8]

                            var Data6 = data6.split(",")

                            var type6 = data6[1]
                            var category6 = data6[2]
                            var price6 = data6[6]
                            var memo6 = data6[8]

                            var Data7 = data7.split(",")

                            var type7 = data7[1]
                            var category7 = data7[2]
                            var price7 = data7[6]
                            var memo7 = data7[8]


                            var Data8 = data8.split(",")

                            var type8 = data8[1]
                            var category8 = data8[2]
                            var price8 = data8[6]
                            var memo8 = data8[8]

                            var Data9 = data9.split(",")

                            var type9 = data9[1]
                            var category9 = data9[2]
                            var price9 = data9[6]
                            var memo9 = data9[8]
